...
3. 然后看 `core-flow.md`，理解消息、AI、TTS/STT、Astrbot、Dashboard 的处理流程。
...
- `data-and-plugin.md`: 自学习数据、数据库适配层、插件接口和扩展方式。
...
- `data/voice-models/` 和 `data/self-learning/` 既包含代码依赖的数据目录，也包含训练与运行产物。
